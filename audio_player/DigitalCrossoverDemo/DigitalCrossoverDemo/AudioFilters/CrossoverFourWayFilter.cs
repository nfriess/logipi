...
{
    /// <summary>
    /// Implements the digital crossover, splitting 2 audio channels into 8.
    /// </summary>
    class CrossoverFourWayFilter : IAudioFilter
    {
        ...
        private void initializeFilterKernels()
        {
            ...
            H_upperMidrange = createUnscaledH(crossover.upperMidFilterKernel, fftSize);
            ...
            overlapLeftUpperMidrange = new Complex[overlapSize];
            ...
            overlapRightUpperMidrange = new Complex[overlapSize];
        ...
        public int read(double[] data, int offset, int count)
        {
            ...
            while (numSamplesComplete < count)
            {
                ...
                data[lastOffset++] = bufferLeftUpperMidrange[lastInputBufferPosition].Real;
                data[lastOffset++] = bufferRightUpperMidrange[lastInputBufferPosition].Real;
        ...
        public void seek(long newPosition)
        {
            ...
            Array.Clear(overlapLeftUpperMidrange, 0, overlapLeftUpperMidrange.Length);
            ...
            Array.Clear(overlapRightUpperMidrange, 0, overlapRightUpperMidrange.Length);
